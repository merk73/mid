(() => {
  ...
  const ensureSearchData = async () => {
    if (!window.MIDGAS_RECORDS?.client || Object.keys(window.MIDGAS_RECORDS.client).length <= 10) {
      for (const src of ["data.js", "featured-data.js?v=8", "client-updates.js?v=5", "incident-updates.js?v=1", "site-completion.js?v=1", "latest-covers.js?v=1"]) await loadScript(src);
    }
